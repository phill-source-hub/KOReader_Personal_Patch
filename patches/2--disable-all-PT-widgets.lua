...
-- ============================================================================
-- VENDORED FROM: https://github.com/SeriousHornet/KOReader.patches/blob/main/2--disable-all-PT-widgets.lua
-- LICENSE:       GPL-3.0 (SeriousHornet)
-- VENDORED ON:   2026-04-17
-- ROLE:          PREREQUISITE — must load before all other VOS patches
-- NOTE:          This patch also removes cover borders (side effect)
-- ============================================================================
