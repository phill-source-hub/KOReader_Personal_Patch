...
-- ============================================================================
-- VENDORED FROM: https://github.com/SeriousHornet/KOReader.patches/blob/main/2-new-progress-bar.lua
-- LICENSE:       GPL-3.0 (SeriousHornet)
-- VENDORED ON:   2026-04-17
-- NOTE:          This patch explicitly SKIPS painting the progress bar when
--                `self.status == "complete"`. This means our checkmark patch
--                doesn't need to fight it on finished books — they coexist
--                cleanly.
-- ============================================================================
